    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full max-w-md flex flex-col justify-center px-10 py-12 bg-card relative z-10">
        <div className="flex items-center gap-3 mb-10">
          ...
          <div>
            <h1 className="text-lg font-bold">FaithFlow</h1>
            <p className="text-xs text-muted-foreground">Ministry Management</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full h-10 rounded-xl border bg-background px-3 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
              />
              <button
                type="button"
        ...
        <button className="w-full h-10 rounded-xl border text-sm font-medium hover:bg-accent transition-colors flex items-center justify-center gap-2">
