...
export default function PaymentOneMoney() {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold">OneMoney Payment</h1>
        ...
        {!showSuccess ? (
          <div className="space-y-6">
            ...
            <div className="card-surface p-6">
              <h2 className="font-semibold mb-4">OneMoney Details</h2>
              <div className="space-y-4">
                <div>
                  <Label>OneMoney Phone Number</Label>
                  <Input
                    type="tel"
                    ...
                    className="mt-1"
                  />
                  <p className="text-xs text-muted-foreground mt-1">Enter your OneMoney registered number</p>
                </div>
                ...
                <div className="bg-accent/50 p-4 rounded-lg">
                  ...
                  <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                    <li>You will receive a OneMoney USSD prompt</li>
                    <li>Enter your OneMoney PIN to authorize</li>
                ...
                <Button className="w-full" onClick={handlePayment}>
                  ...
                  Pay ${paymentDetails.amount} via OneMoney
                </Button>
              </div>
            </div>
          </div>
